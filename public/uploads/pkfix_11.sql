...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 27, 2021 at 01:15 PM
...
(9, 1, 'Coba Absen', '2021-09-27 13:26:00', '2021-09-27 13:45:00', '2021-09-27', 1);
...
--
ALTER TABLE `wadahpresensi`
  MODIFY `id_wadah` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `rekrutasisten`
  ADD CONSTRAINT `fkwadahform` FOREIGN KEY (`id_form`) REFERENCES `wadahform` (`id_form`),

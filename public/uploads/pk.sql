...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 24, 2021 at 06:25 AM
...
--
ALTER TABLE `proses_praktikum`
  MODIFY `id_proses` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `wadah_tugas`
  MODIFY `id_wadahtugas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

...
CREATE TABLE `proses_praktikum` (
  ...
  KEY `presensipraktikum` (`id_presensi`),
  ...
  CONSTRAINT `presensipraktikum` FOREIGN KEY (`id_presensi`) REFERENCES `presensi` (`id_presensi`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `wadahpresensi` (
  ...
  KEY `wadahpresensifk` (`id_pertemuan`),
  CONSTRAINT `wadahpresensifk` FOREIGN KEY (`id_pertemuan`) REFERENCES `pertemuan` (`id_pertemuan`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

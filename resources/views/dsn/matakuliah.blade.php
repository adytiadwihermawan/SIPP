          ...
          <div class="modal fade" id="addmateri">
            ...
            <div class="card-body">
                <div class="row mb-5 mx-auto">
                    <div class="col-sm">
                        <button type="button" class="btn hijau panjang2 " data-toggle="modal" data-target="#addmateri">
                            <i class="fas fa-plus"></i> Tambah Materi </button>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <form action="{{ route('fileUpload') }}" method="post"
                                                ...
                                                @endif
                                                <input type="text" class="form-control" name="id_pertemuan"
                                                    value="{{ old('id', $item->id_pertemuan)}}" readonly>
                                                <input type="file" name="_file" id="_file" style="margin-bottom:15px;"
                                                    class="form-control">
                                                <button type="submit" style="float:right; margin-bottom:15px;"
                    ...
                    <div class="col-sm">
                        <button type="button" class="btn hijau3 panjang2 " data-toggle="modal" data-target="#"> <i
                                class="fas fa-plus"></i> Edit Pertemuan </button>
                    </div>

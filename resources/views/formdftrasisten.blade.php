  ...
  <div id="card">
    <div id="card-content">
      ...
      <form method="post" class="form">
        ...
        <input id="user-nim" class="form-content" type="text" name="nim" autocomplete="on" required />
        <div class="form-border"></div>

        <label for="user-no" style="padding-top:13px">
            &nbsp;No HP
          </label>
        <input id="user-no" class="form-content" type="number" name="no" autocomplete="on" required />
        <div class="form-border"></div>

        <label for="user-ipk" style="padding-top:13px">
            &nbsp;IPK
          </label>
        <input id="user-ipk" class="form-content" type="number" name="ipk" autocomplete="on" required />
        <div class="form-border"></div>
